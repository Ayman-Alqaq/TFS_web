<?php
	...
	$config['site_title'] = 'Daritica';
	$config['site_title_context'] = 'Welcome to Daritica';
	$config['site_url'] = "http://daritica.myftp.org";
	...
	$config['sqlPassword'] = '8uoc+HP0qzFZ+oIUSJPwrU7R';
	...
	function getClock($time = false, $format = false, $adjust = true) {
		...
		if ($adjust) $adjust = (-7 * 3600); // Adjust to fit your timezone. 1 * 3600
		else $adjust = 0;
	...
	$config['EnableQuests'] = false; //false
	...
	*/
	...
	$config['available_vocations'] = array(0);//array(1, 2, 3, 4);

	// Available towns (specify town ids, etc: (1, 2, 3); to display 3 town options (town id 1, 2 and 3).
	$config['available_towns'] = array(58);//array(1, 2, 4, 5)
	...
	$config['delete_character_interval'] = '1 HOUR'; //3 DAY Delay after user character delete request is executed eg. 1 DAY, 2 HOUR, 3 MONTH etc. 
	...
	$config['show_outfits'] = array(
		...
		'imageServer' => 'http://outfit-images.ots.me/animatedOutfits1099/outfit.php'
	...
	$config['guildwar_enabled'] = true; //false
	...
	/*$config['client_download'] = 'http://daritica.servegame.com/downloads/tibia1098.exe';*/
	...
	$config['cache_lifespan'] = 60*15;//5//60 * 15; // 15 minutes.
	...
	*/
	...
	'host' => "smtp.mail.yahoo.com", // Outgoing mail server host.
	'securityType' => 'ssl', // ssl or tls
	'port' => 465, // SMTP port number - likely to be 465(ssl) or 587(tls)
	'email' => 'GMFabled@yahoo.com', 
	'username' => 'GMFabled@yahoo.com', // Likely the same as email
	'password' => 'german123', // The password.
	'debug' => false, // Enable debugging if you have problems and are looking for errors.
	'fromName' => $config['site_title'],
	);
	...
	*/
	...
	$config['paypal'] = array(
		'enabled' => true,
		'email' => 'aalqaq2@yahoo.com', // Example: paypal@mail.com
		'currency' => 'USD',
		'points_per_currency' => 50, // 1 currency = ? points? [ONLY used to calculate bonuses]
...
*/
	...
	$config['shop_auction'] = array(
		'characterAuction' => false, //false// Enable/disable this system
		'requiredLevel' => 50, // Minimum level of sold character
		'leastValue' => 150, //10// Lowest donation points a char can be sold for.
	...
	$config['shop_offers'] = array(
		...
		***************************************/
		8 => array(
			...
			'itemid' => 2276,
			'count' => 1,
			'description' => "Points Rune (100 points)",
			'points' => 110,
		),
		9 => array(
			'type' => 1,
			'itemid' => 2300,
			'count' => 1,
			'description' => "Points Rune (500 points)",
			'points' => 550,
		),
		10 => array(
			'type' => 1,
			'itemid' => 2314,
			'count' => 1,
			'description' => "Points Rune (1000 points)",
			'points' => 1100,
		),
		11 => array(
			'type' => 1,
			'itemid' => 2281,
			'count' => 1,
			'description' => "Points Rune (2000 points)",
			'points' => 2200,
		),
		12 => array(
			'type' => 1,
		...
		14 => array(
			'type' => 1,
			'itemid' => 2294, // Item to display on page
			'count' => 20,
			'description' => "Enchantment Rune",
			'points' => 1000,
		),
		/***************************************
						Others
		...
		***************************************/
		17 => array(
			'type' => 1,
			'itemid' => 2656, // item to get in-game
			'count' => 1, // Stack number (5x itemid)
			'description' => "Blue Robe", // Description shown on website
			'points' => 40, // How many points this offer costs
		),
		18 => array(
			'type' => 1,
			'itemid' => 2472,
			'count' => 1,
			'description' => "Magic Plate Armor",
			'points' => 150,
		),
		19 => array(
			'type' => 1,
		...
		20 => array(
			...
			'itemid' => 8918,
			'count' => 1,
			'description' => "Spellbook of Dark Mysteries",
			'points' => 250,
		),
		21 => array(
			'type' => 1,
			'itemid' => 9774,
			'count' => 1,
			'description' => "Fabled Backpack (Vol: 42)",
			'points' => 200,
		),
		22 => array(
			'type' => 1,
		...
		30 => array(
			...
			'itemid' => 2358,
			'count' => 1,
			'description' => "Boots of Salvation",
			'points' => 3000,
		),	
		31 => array(
			'type' => 1,
