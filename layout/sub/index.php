...
if ($news) {
	...
	echo '<div id="newz">';// Most powerful guilds for TFS 0.3/4 and 1.0


	foreach ($news as $n) {
		?>
		<div class="news_title"><?php echo getClock($n['date'], true) .' by <a href="characterprofile.php?name='. $n['name'] .'">'. $n['name'] .'</a> - '. TransformToBBCode($n['title']); ?></div>
